...
AgentFlow-RS 是一个使用 Rust 编写的高性能、强类型的 AI 智能体工作流引擎。系统立足于“配置即代码”的声明式思想，构建了严谨的**有向无环图 (DAG)** 调度内核，并横向扩展了 **GUI 可视化设计态**、**TUI 极客运行态** 与 **Headless Web 微服务** 三大形态，助力开发者快速构建具有可视化工作流设计编排、ReAct 自主思考、本地 RAG 检索与多模态文件解析能力的前沿 AI 原生应用。
